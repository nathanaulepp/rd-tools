...
const VALIDATED_KEYS = [
  ...
  "ht", "wt", "ubw", "ubwDate", "waist", "mac", "calf", "head", "triceps", "subscapular", "suprailiac", "thigh", "edw", "circUnit", "past_ht", "past_wt", "past_head", "past_htDate", "past_wtDate", "past_headDate", "amputations", "dexaScans",
  "chiefComplaint", "medHx", "familyHx", "socialHx", "allergiesIntolerances", "medicalDevices", "medications", "temp", "hr", "spo2", "bp", "rr", "temples", "clavicles", "shoulders", "scapula", "interosseous", "thighs", "calves", "orbital", "cheek", "tricepsFat", "midAxillary", "pittingEdema", "pedalEdema", "ascites", "gripStrength", "giDistress", "chewing", "swallowing", "imaging_smi", "tempMax", "ve", "fev1", "tbsa", "clinicalNotes", "screenings", "oralHygiene", "edemaDescription", "imaging_muscleAttenuation", "imaging_imat", "imaging_vat", "imaging_notes", "hair", "eyes", "mouthLips", "tongue", "teethGums", "headNeck", "nails", "skin",
