...
// SAMPLE DATA HARVEST: NCM Core baseline intersecting with Custom ASPEN / Specialist Extensions
const CLINICAL_LIBRARY_DATA: ClinicalField[] = [
  {
    id: "MNT-REN",
