...
export default function ClinicalDomain({ clinical, setClinical }: any) {
  ...
  const microOptionsTongue = ["WNL", "Glossitis", "Scorbutic", "Pale", "Magenta", "Beefy Red, Smooth", "Thrush", "Geographic", "Strawberry", "Dysguesia", "Other"];
  const microOptionsTeethGums = ["WNL", "Gingivitis, Scorbutic", "Dark Spots", "Mottling", "White streaks", "Delayed Tooth Eruption", "Caries", "White or Yellow Bands", "Other"];
  ...
  const micronutrientCategories = [
    ...
    { area: "Eyes", options: microOptionsEyes },
    { area: "MouthLips", options: microOptionsMouthLips },
    { area: "Tongue", options: microOptionsTongue },
