...
export type { HospitalDiet, HospitalDietInput } from '../shared/api/db.commands';
export type { HospitalDysphagiaMode, HospitalDysphagiaModInput } from '../shared/api/db.commands';
