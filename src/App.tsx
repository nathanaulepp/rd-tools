...
import ReferenceLibrary from "./components/reading_resources/ReferenceLibrary";
...
export default function App() {
  ...
  if (currentView === "RESOURCES") {
    return (
      <div className="generic-page" style={{ padding: "1.5rem", height: "100vh", boxSizing: "border-box", display: "flex", flexDirection: "column" }}>
        <header className="page-header" style={{ display: "flex", alignItems: "center", gap: "1.5rem", marginBottom: "1rem" }}>
